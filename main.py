...
test = RamanSpectrumImage(".\\data\\surface\\25-09-2020\\test.tif")
test2 = RamanSpectrumImage(".\\data\\surface\\25-09-2020\\test.tif")
...
# rmg1.add_image()
rmg1.add_plot(figsize=(6, 4), xunit='cm-1', xlimits=(2, 1340), ylimits=(20, 400),  normalized=False, uncurved=True, label=", Vodka [40% eth] on SERS , 5min, 31mW", majorTicks=250, minorTicks="auto")
rmg1.show()
